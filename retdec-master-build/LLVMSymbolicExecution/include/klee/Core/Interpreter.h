...
public:
  ...
  virtual void setThisPointerMemoryObject(klee::MemoryObject *mo) = 0;
  virtual void instrumentMemoryOperation(bool isWrite,const klee::MemoryObject *mo, uint64_t offset, uint64_t width) = 0;
};
...
public:
  ...
  virtual void initSingleModule(llvm::Module* moduleptr)=0 ;
