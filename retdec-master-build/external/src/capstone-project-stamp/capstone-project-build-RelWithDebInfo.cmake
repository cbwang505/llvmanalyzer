...
set(stdout_log "E:/git/WindowsResearch/retdec-master-build/external/src/capstone-project-stamp/capstone-project-build-out.log")
set(stderr_log "E:/git/WindowsResearch/retdec-master-build/external/src/capstone-project-stamp/capstone-project-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  E:/git/WindowsResearch/retdec-master-build/external/src/capstone-project-stamp/capstone-project-build-*.log")
  endif()
  ...
  if(NOT "Visual Studio 15 2017" MATCHES "Ninja")
    set(msg "capstone-project build command succeeded.  See also E:/git/WindowsResearch/retdec-master-build/external/src/capstone-project-stamp/capstone-project-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
