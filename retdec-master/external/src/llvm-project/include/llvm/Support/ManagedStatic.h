...
// RetDec: Added here to solve https://github.com/avast/retdec/issues/895
//         from https://reviews.llvm.org/D80433
//         There is no need to migrate this to newer LLVM versions.
