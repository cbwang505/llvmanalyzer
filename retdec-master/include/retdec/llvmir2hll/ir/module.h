...
public:
	...
	void addGlobal2VariablePair(llvm::GlobalVariable* g, ShPtr<Variable> v);
	bool isSkipGlobalVariable(llvm::GlobalVariable* g);
	...
	bool isSkipVariable(ShPtr<Variable> v);
...
private:
	...
	std::map<ShPtr<Variable> ,llvm::GlobalVariable* > Var2Global;
	/// Functions.
	FuncVector funcs;
