...
private:
	...
	/// The used HLL writer.
	ShPtr<llvmir2hll::HLLWriter> hllWriter = nullptr;

	ShPtr<llvmir2hll::HLLWriter> idaStructWriter = nullptr;
	...
	std::unique_ptr<llvm::raw_string_ostream> outStringStream = nullptr;
};
