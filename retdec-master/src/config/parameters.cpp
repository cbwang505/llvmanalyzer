...
const std::string JSON_outputBinFile            = "outputBinFile";
...
void Parameters::setOutputBinFile(const std::string& file)
{
	_outputBinFile = file;
}
...
const std::string& Parameters::getOutputBinFile() const
{
	return _outputBinFile;
}
...
void Parameters::serialize(Writer& writer) const
{
	...
	serdes::serializeString(writer, JSON_outputBinFile, getOutputBinFile());
...
void Parameters::deserialize(const rapidjson::Value& val)
{
	...
	setOutputBinFile( serdes::deserializeString(val, JSON_outputBinFile) );
